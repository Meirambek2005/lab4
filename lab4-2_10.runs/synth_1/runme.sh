...
HD_PWD='C:/Users/admin/lab4-2_10/lab4-2_10.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log level1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source level1.tcl
